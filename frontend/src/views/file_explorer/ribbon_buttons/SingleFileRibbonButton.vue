...
<template>
    <div class="ribbon-button"
         ...
         :class="[{disabled : notAvailable},btn_cls]"
    >
        ...
        <vue-final-modal
                ...
                :hide-overlay="true"
        >
            <span class="modal__title">{{ dialog_title }}</span>
            <div class="modal__content" style="margin-top: 1rem;margin-bottom: 1rem;">
                <slot></slot>
            </div>
